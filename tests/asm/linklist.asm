...
; Entry 1149; block 1; address 115b
L1149_1:
...
; Entry 1149; block 2; address 1173
L1149_2:
  MOV RDX, RAX
  MOV RAX, qword [RBP - 0x10]
  ...
  JMP L1149_4    ; 0x11ce --> L1149_4

; Entry 1149; block 5; address 11a6
L1149_5:
...
; Entry 1149; block 3; address 11c2
L1149_3:
  MOV RAX, qword [RBP - 0x8]
  MOV RAX, qword [RAX + 0x8]
  MOV qword [RBP - 0x8], RAX

; Entry 1149; block 4; address 11ce
L1149_4:
  CMP qword [RBP - 0x8], 0x0
  JNZ L1149_5    ; 0x11a6 --> L1149_5

; Entry 1149; block 6; address 11d5
L1149_6:
  MOV EAX, 0x0
  LEAVE
  RET
...
; Function: _fini
; ---------------
; Entry 11dc; block 0; address 11dc
_fini:
  SUB RSP, 0x8
  ADD RSP, 0x8
  RET
